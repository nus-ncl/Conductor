...
def ansiblefile_renderer(vms):
	...
	for vm in vms:
		...
		for service in vm['service']:
			...
			# content = ansiblefile.render(vm=vm, USER='{{ ansible_env.USER }}', \
			#                              item='{{ item }}', conductor_path=ROOT_DIR, \
			#                              mount_src_ip='{{ mount_src_ip }}', \
			#                              mount_src_directory='{{ mount_src_directory }}', \
			#                              mount_dest_directory='{{ mount_dest_directory }}')
