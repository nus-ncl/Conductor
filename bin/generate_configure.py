...
def cfg_generator(sections_list, keys_list, values_list, filename=default.GENERATED_CONFIG_FILE):
		'''
...
if __name__ == "__main__":
		...
		values = [['CS4238-19-01', 'Exp3', '1', '2', '2'], \
		          ...
		          ['n2', 'VM1', 'virtualbox', 'vboxnet0', '172.16.1.101', 'generic/ubuntu1910',
		           'essentials,python,php,django,attribution,blx,binspace,zara,klara', 'CVE-2013-2028'], \
		          ['n2', 'VM2', 'virtualbox', 'vboxnet0', '172.16.1.102', 'generic/ubuntu1910', 'flowsim', '']]
